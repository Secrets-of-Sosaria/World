    ...
    class ChangeLog
    {
		...
		public static string Versions()
        {
			string versionTEXT = ""
				...
				+ "<br>"
				+ "* Added Ethereal and Eternal power scrolls to the game. They can be found as endgame loot.<br>"
				...
				+ "* Added starting equipment for new characters based on their chosen skills. Mages will start with their spellbooks, crafters with related tools, archers with bows and so on.<br>"
				+ "* Shovels can now be used to dig for treasure directly from the backpack.<br>"
				+ "* Holy priest mallets can now be bought at priests, and the requirement to unlock the class has been lowered.<br>"
				+ "* Scale armor no longer drops. It can still be crafted.<br>"
				+ "* Cooldown of the acid proof robe has been reduced from 2 hours to 30 minutes for generating acid bottles. Those bottles can also be used when the robe is not being worn.<br>"
				...
				+ "* Added 31 new taming-related artifacts to the game. They can be found via random drop and sage quest.<br>"
				...
				+ "* Made hunger/thirst influence skill gain slightly. Well fed characters will have faster gains, while hungry/thirsty characters will have slower gains.<br>"
				...
				+ "* Added a small chance that an adventurer found in the wilds will have a rare item on their bag, that can be stolen or taken if the adventurer is murdered.<br>"
