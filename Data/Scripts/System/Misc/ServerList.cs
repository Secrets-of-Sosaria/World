...
namespace Server.Misc
{
	public class ServerList
	{
		...
		public static readonly bool EnforceAddress = MySettings.S_EnforceAddress;
		...
		private static void EventSink_ServerList( ServerListEventArgs e )
		{
			try
			{
				...
				if ( EnforceAddress ) {
					Console.WriteLine("ServerList: EnforceAddress is set to true, overriding the detected IP");
					localAddress = m_PublicAddress;
				}

				Console.WriteLine("ServerList: Serving the Game Server at {0}", localAddress.ToString());
