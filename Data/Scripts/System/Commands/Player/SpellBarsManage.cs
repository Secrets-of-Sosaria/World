...
namespace Server.Gumps 
{
	public class SetupBarsArch1 : Gump
    {
		...
		{
            CommandSystem.Register( "archspell1", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public SetupBarsArch1 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ANCIENT - I</BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 624, 81, 261, 21, @"<BODY><BASEFONT Color=" + color + ">Show Spell Names When Vertical</BASEFONT></BODY>", (bool)false, (bool)false);

			AddButton(377, 540, button66, button66, 91, GumpButtonType.Reply, 0);
			AddHtml( 417, 539, 125, 21, @"<BODY><BASEFONT Color=" + color + ">Vertical Bar</BASEFONT></BODY>", (bool)false, (bool)false);

			AddButton(681, 537, button67, button67, 91, GumpButtonType.Reply, 0);
			AddHtml( 721, 536, 125, 21, @"<BODY><BASEFONT Color=" + color + ">Horizontal Bar</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 11 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 12 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 13 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 14 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 15 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 16 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 17 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 18 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 19 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 20 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 21 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 22 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 23 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 24 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 25 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 26 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 27 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 28 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 29 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 30 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 31 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 32 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 33 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 34 ){ ToolBarUpdates.UpdateToolBar( from, 35, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 35 ){ ToolBarUpdates.UpdateToolBar( from, 36, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 36 ){ ToolBarUpdates.UpdateToolBar( from, 37, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 37 ){ ToolBarUpdates.UpdateToolBar( from, 38, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 38 ){ ToolBarUpdates.UpdateToolBar( from, 39, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 39 ){ ToolBarUpdates.UpdateToolBar( from, 40, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 40 ){ ToolBarUpdates.UpdateToolBar( from, 41, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 41 ){ ToolBarUpdates.UpdateToolBar( from, 42, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 42 ){ ToolBarUpdates.UpdateToolBar( from, 43, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 43 ){ ToolBarUpdates.UpdateToolBar( from, 44, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 44 ){ ToolBarUpdates.UpdateToolBar( from, 45, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 45 ){ ToolBarUpdates.UpdateToolBar( from, 46, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 46 ){ ToolBarUpdates.UpdateToolBar( from, 47, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 47 ){ ToolBarUpdates.UpdateToolBar( from, 48, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 48 ){ ToolBarUpdates.UpdateToolBar( from, 49, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 49 ){ ToolBarUpdates.UpdateToolBar( from, 50, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 50 ){ ToolBarUpdates.UpdateToolBar( from, 51, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 51 ){ ToolBarUpdates.UpdateToolBar( from, 52, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 52 ){ ToolBarUpdates.UpdateToolBar( from, 53, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 53 ){ ToolBarUpdates.UpdateToolBar( from, 54, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 54 ){ ToolBarUpdates.UpdateToolBar( from, 55, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 55 ){ ToolBarUpdates.UpdateToolBar( from, 56, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 56 ){ ToolBarUpdates.UpdateToolBar( from, 57, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 57 ){ ToolBarUpdates.UpdateToolBar( from, 58, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 58 ){ ToolBarUpdates.UpdateToolBar( from, 59, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 59 ){ ToolBarUpdates.UpdateToolBar( from, 60, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 60 ){ ToolBarUpdates.UpdateToolBar( from, 61, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 61 ){ ToolBarUpdates.UpdateToolBar( from, 62, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 62 ){ ToolBarUpdates.UpdateToolBar( from, 63, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 63 ){ ToolBarUpdates.UpdateToolBar( from, 64, "SetupBarsArch1", 66 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 65, "SetupBarsArch1", 66 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 66, "SetupBarsArch1", 66 ); }
			...
			if ( info.ButtonID < 1 && m_Origin > 1 )
			{
				if ( Server.Misc.ResearchSettings.ResearchMaterials( from ) != null )
				{
					...
					from.SendGump( new Server.Items.ResearchBag.ResearchGump( bag, from ) ); from.SendSound( 0x55 );
				}
			}
			else if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.SendSound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsArch1( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsArch2 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "archspell2", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public static void ToolBar_OnCommand( CommandEventArgs e )
		{
 		...
 		public SetupBarsArch2 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ANCIENT - II</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 11 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 12 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 13 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 14 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 15 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 16 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 17 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 18 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 19 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 20 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 21 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 22 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 23 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 24 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 25 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 26 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 27 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 28 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 29 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 30 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 31 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 32 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 33 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 34 ){ ToolBarUpdates.UpdateToolBar( from, 35, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 35 ){ ToolBarUpdates.UpdateToolBar( from, 36, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 36 ){ ToolBarUpdates.UpdateToolBar( from, 37, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 37 ){ ToolBarUpdates.UpdateToolBar( from, 38, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 38 ){ ToolBarUpdates.UpdateToolBar( from, 39, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 39 ){ ToolBarUpdates.UpdateToolBar( from, 40, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 40 ){ ToolBarUpdates.UpdateToolBar( from, 41, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 41 ){ ToolBarUpdates.UpdateToolBar( from, 42, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 42 ){ ToolBarUpdates.UpdateToolBar( from, 43, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 43 ){ ToolBarUpdates.UpdateToolBar( from, 44, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 44 ){ ToolBarUpdates.UpdateToolBar( from, 45, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 45 ){ ToolBarUpdates.UpdateToolBar( from, 46, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 46 ){ ToolBarUpdates.UpdateToolBar( from, 47, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 47 ){ ToolBarUpdates.UpdateToolBar( from, 48, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 48 ){ ToolBarUpdates.UpdateToolBar( from, 49, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 49 ){ ToolBarUpdates.UpdateToolBar( from, 50, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 50 ){ ToolBarUpdates.UpdateToolBar( from, 51, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 51 ){ ToolBarUpdates.UpdateToolBar( from, 52, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 52 ){ ToolBarUpdates.UpdateToolBar( from, 53, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 53 ){ ToolBarUpdates.UpdateToolBar( from, 54, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 54 ){ ToolBarUpdates.UpdateToolBar( from, 55, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 55 ){ ToolBarUpdates.UpdateToolBar( from, 56, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 56 ){ ToolBarUpdates.UpdateToolBar( from, 57, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 57 ){ ToolBarUpdates.UpdateToolBar( from, 58, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 58 ){ ToolBarUpdates.UpdateToolBar( from, 59, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 59 ){ ToolBarUpdates.UpdateToolBar( from, 60, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 60 ){ ToolBarUpdates.UpdateToolBar( from, 61, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 61 ){ ToolBarUpdates.UpdateToolBar( from, 62, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 62 ){ ToolBarUpdates.UpdateToolBar( from, 63, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 63 ){ ToolBarUpdates.UpdateToolBar( from, 64, "SetupBarsArch2", 66 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 65, "SetupBarsArch2", 66 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 66, "SetupBarsArch2", 66 ); }
			...
			else { from.SendGump( new SetupBarsArch2( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsArch3 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "archspell3", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public static void ToolBar_OnCommand( CommandEventArgs e )
		{
 		...
 		public SetupBarsArch3 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ANCIENT - III</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 11 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 12 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 13 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 14 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 15 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 16 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 17 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 18 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 19 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 20 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 21 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 22 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 23 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 24 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 25 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 26 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 27 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 28 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 29 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 30 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 31 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 32 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 33 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 34 ){ ToolBarUpdates.UpdateToolBar( from, 35, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 35 ){ ToolBarUpdates.UpdateToolBar( from, 36, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 36 ){ ToolBarUpdates.UpdateToolBar( from, 37, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 37 ){ ToolBarUpdates.UpdateToolBar( from, 38, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 38 ){ ToolBarUpdates.UpdateToolBar( from, 39, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 39 ){ ToolBarUpdates.UpdateToolBar( from, 40, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 40 ){ ToolBarUpdates.UpdateToolBar( from, 41, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 41 ){ ToolBarUpdates.UpdateToolBar( from, 42, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 42 ){ ToolBarUpdates.UpdateToolBar( from, 43, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 43 ){ ToolBarUpdates.UpdateToolBar( from, 44, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 44 ){ ToolBarUpdates.UpdateToolBar( from, 45, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 45 ){ ToolBarUpdates.UpdateToolBar( from, 46, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 46 ){ ToolBarUpdates.UpdateToolBar( from, 47, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 47 ){ ToolBarUpdates.UpdateToolBar( from, 48, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 48 ){ ToolBarUpdates.UpdateToolBar( from, 49, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 49 ){ ToolBarUpdates.UpdateToolBar( from, 50, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 50 ){ ToolBarUpdates.UpdateToolBar( from, 51, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 51 ){ ToolBarUpdates.UpdateToolBar( from, 52, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 52 ){ ToolBarUpdates.UpdateToolBar( from, 53, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 53 ){ ToolBarUpdates.UpdateToolBar( from, 54, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 54 ){ ToolBarUpdates.UpdateToolBar( from, 55, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 55 ){ ToolBarUpdates.UpdateToolBar( from, 56, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 56 ){ ToolBarUpdates.UpdateToolBar( from, 57, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 57 ){ ToolBarUpdates.UpdateToolBar( from, 58, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 58 ){ ToolBarUpdates.UpdateToolBar( from, 59, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 59 ){ ToolBarUpdates.UpdateToolBar( from, 60, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 60 ){ ToolBarUpdates.UpdateToolBar( from, 61, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 61 ){ ToolBarUpdates.UpdateToolBar( from, 62, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 62 ){ ToolBarUpdates.UpdateToolBar( from, 63, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 63 ){ ToolBarUpdates.UpdateToolBar( from, 64, "SetupBarsArch3", 66 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 65, "SetupBarsArch3", 66 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 66, "SetupBarsArch3", 66 ); }
			...
			else { from.SendGump( new SetupBarsArch3( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsArch4 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "archspell4", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public SetupBarsArch4 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ANCIENT - IV</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 11 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 12 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 13 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 14 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 15 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 16 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 17 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 18 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 19 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 20 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 21 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 22 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 23 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 24 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 25 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 26 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 27 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 28 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 29 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 30 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 31 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 32 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 33 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 34 ){ ToolBarUpdates.UpdateToolBar( from, 35, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 35 ){ ToolBarUpdates.UpdateToolBar( from, 36, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 36 ){ ToolBarUpdates.UpdateToolBar( from, 37, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 37 ){ ToolBarUpdates.UpdateToolBar( from, 38, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 38 ){ ToolBarUpdates.UpdateToolBar( from, 39, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 39 ){ ToolBarUpdates.UpdateToolBar( from, 40, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 40 ){ ToolBarUpdates.UpdateToolBar( from, 41, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 41 ){ ToolBarUpdates.UpdateToolBar( from, 42, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 42 ){ ToolBarUpdates.UpdateToolBar( from, 43, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 43 ){ ToolBarUpdates.UpdateToolBar( from, 44, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 44 ){ ToolBarUpdates.UpdateToolBar( from, 45, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 45 ){ ToolBarUpdates.UpdateToolBar( from, 46, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 46 ){ ToolBarUpdates.UpdateToolBar( from, 47, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 47 ){ ToolBarUpdates.UpdateToolBar( from, 48, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 48 ){ ToolBarUpdates.UpdateToolBar( from, 49, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 49 ){ ToolBarUpdates.UpdateToolBar( from, 50, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 50 ){ ToolBarUpdates.UpdateToolBar( from, 51, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 51 ){ ToolBarUpdates.UpdateToolBar( from, 52, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 52 ){ ToolBarUpdates.UpdateToolBar( from, 53, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 53 ){ ToolBarUpdates.UpdateToolBar( from, 54, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 54 ){ ToolBarUpdates.UpdateToolBar( from, 55, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 55 ){ ToolBarUpdates.UpdateToolBar( from, 56, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 56 ){ ToolBarUpdates.UpdateToolBar( from, 57, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 57 ){ ToolBarUpdates.UpdateToolBar( from, 58, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 58 ){ ToolBarUpdates.UpdateToolBar( from, 59, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 59 ){ ToolBarUpdates.UpdateToolBar( from, 60, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 60 ){ ToolBarUpdates.UpdateToolBar( from, 61, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 61 ){ ToolBarUpdates.UpdateToolBar( from, 62, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 62 ){ ToolBarUpdates.UpdateToolBar( from, 63, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 63 ){ ToolBarUpdates.UpdateToolBar( from, 64, "SetupBarsArch4", 66 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 65, "SetupBarsArch4", 66 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 66, "SetupBarsArch4", 66 ); }
			...
			else { from.SendGump( new SetupBarsArch4( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
	public class SetupBarsMage1 : Gump
    {
		...
		public SetupBarsMage1 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - MAGERY - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsMage2 : Gump
    {
		...
		public static void ToolBar_OnCommand( CommandEventArgs e )
		{
 		...
 		public SetupBarsMage2 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - MAGERY - II</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsMage3 : Gump
    {
		...
		public static void ToolBar_OnCommand( CommandEventArgs e )
		{
 		...
 		public SetupBarsMage3 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - MAGERY - III</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsMage4 : Gump
    {
		...
		public SetupBarsMage4 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - MAGERY - IV</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsElement1 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "elementspell1", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public SetupBarsElement1 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ELEMENTALIST - I</BASEFONT></BODY>", (bool)false, (bool)false);
			...
			foreach (string eachSpells in eachSpell)
			{
				...
				if ( nLine == 33 && eachSpells == "1" ) { button65 = 4018; }

				if ( nLine == 34 && eachSpells == "0" ) { button66 = 3609; }
				else if ( nLine == 34 && eachSpells == "1" ) { button66 = 4018; }

				if ( nLine == 34 && eachSpells == "1" ) { button67 = 3609; }
				else if ( nLine == 34 && eachSpells == "0" ) { button67 = 4018; }
			...
			if ( spel == 1 ){ 		book = 0x6713;	}
			else if ( spel == 2 ){ 	book = 0x6719;	}
			else if ( spel == 3 ){ 	book = 0x6715;	}
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 301 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 302 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 303 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 304 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 305 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 306 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 307 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 308 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 309 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 310 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 311 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 312 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 313 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 314 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 315 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 316 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 317 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 318 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 319 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 320 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 321 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 322 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 323 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 324 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 325 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 326 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 327 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 328 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 329 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 330 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 331 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsElly1", 34 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsElly1", 34 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsElly1", 34 ); }

			if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.SendSound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsElement1( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsElement2 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "elementspell2", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
		...
		public SetupBarsElement2 ( Mobile from, int origin ) : base ( 12,50 )
		{
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - ELEMENTALIST - II</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 99 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 301 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 302 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 303 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 304 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 305 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 306 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 307 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 308 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 309 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 310 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 311 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 312 ){ ToolBarUpdates.UpdateToolBar( from, 13, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 313 ){ ToolBarUpdates.UpdateToolBar( from, 14, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 314 ){ ToolBarUpdates.UpdateToolBar( from, 15, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 315 ){ ToolBarUpdates.UpdateToolBar( from, 16, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 316 ){ ToolBarUpdates.UpdateToolBar( from, 17, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 317 ){ ToolBarUpdates.UpdateToolBar( from, 18, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 318 ){ ToolBarUpdates.UpdateToolBar( from, 19, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 319 ){ ToolBarUpdates.UpdateToolBar( from, 20, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 320 ){ ToolBarUpdates.UpdateToolBar( from, 21, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 321 ){ ToolBarUpdates.UpdateToolBar( from, 22, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 322 ){ ToolBarUpdates.UpdateToolBar( from, 23, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 323 ){ ToolBarUpdates.UpdateToolBar( from, 24, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 324 ){ ToolBarUpdates.UpdateToolBar( from, 25, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 325 ){ ToolBarUpdates.UpdateToolBar( from, 26, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 326 ){ ToolBarUpdates.UpdateToolBar( from, 27, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 327 ){ ToolBarUpdates.UpdateToolBar( from, 28, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 328 ){ ToolBarUpdates.UpdateToolBar( from, 29, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 329 ){ ToolBarUpdates.UpdateToolBar( from, 30, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 330 ){ ToolBarUpdates.UpdateToolBar( from, 31, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 331 ){ ToolBarUpdates.UpdateToolBar( from, 32, "SetupBarsElly2", 34 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 33, "SetupBarsElly2", 34 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 34, "SetupBarsElly2", 34 ); }

			if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.SendSound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsElement2( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsNecro1 : Gump
    {
        ...
        public SetupBarsNecro1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - NECROMANCER - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsNecro2 : Gump
    {
        ...
        public SetupBarsNecro2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - NECROMANCER - II</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsKnight1 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "knightspell1", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
        ...
        public SetupBarsKnight1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - KNIGHT - I</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsKnight1", 12 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsKnight1", 12 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsKnight1", 12 ); }

			if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.SendSound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsKnight1( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsKnight2 : Gump
    {
		...
		public static void Initialize()
		{
            CommandSystem.Register( "knightspell2", AccessLevel.Player, new CommandEventHandler( ToolBar_OnCommand ) );
		}
        ...
        public SetupBarsKnight2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - KNIGHT - II</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID == 1 ){ ToolBarUpdates.UpdateToolBar( from, 1, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 2 ){ ToolBarUpdates.UpdateToolBar( from, 2, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 3 ){ ToolBarUpdates.UpdateToolBar( from, 3, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 4 ){ ToolBarUpdates.UpdateToolBar( from, 4, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 5 ){ ToolBarUpdates.UpdateToolBar( from, 5, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 6 ){ ToolBarUpdates.UpdateToolBar( from, 6, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 7 ){ ToolBarUpdates.UpdateToolBar( from, 7, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 8 ){ ToolBarUpdates.UpdateToolBar( from, 8, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 9 ){ ToolBarUpdates.UpdateToolBar( from, 9, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 10 ){ ToolBarUpdates.UpdateToolBar( from, 10, "SetupBarsKnight2", 12 ); }

			else if ( info.ButtonID == 90 ){ ToolBarUpdates.UpdateToolBar( from, 11, "SetupBarsKnight2", 12 ); }
			else if ( info.ButtonID == 91 ){ ToolBarUpdates.UpdateToolBar( from, 12, "SetupBarsKnight2", 12 ); }

			if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.SendSound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsKnight2( from, m_Origin ) ); from.SendSound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsBard1 : Gump
    {
        ...
        public SetupBarsBard1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - BARD - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsBard2 : Gump
    {
        ...
        public SetupBarsBard2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - BARD - II</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsDeath1 : Gump
    {
        ...
        public SetupBarsDeath1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - DEATH KNIGHT - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsDeath2 : Gump
    {
        ...
        public SetupBarsDeath2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - DEATH KNIGHT - II</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsPriest1 : Gump
    {
        ...
        public SetupBarsPriest1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - PRIEST - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsPriest2 : Gump
    {
        ...
        public SetupBarsPriest2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">SPELL BAR - PRIEST - II</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsMonk1 : Gump
    {
        ...
        public SetupBarsMonk1 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">ABILITY BAR - MONKS - I</BASEFONT></BODY>", (bool)false, (bool)false);
...
namespace Server.Gumps 
{
    public class SetupBarsMonk2 : Gump
    {
        ...
        public SetupBarsMonk2 ( Mobile from, int origin ) : base ( 12,50 )
        {
			m_Origin = origin;
			string color = "#d05f5a";
			...
			AddImage(38, 0, 9578, Server.Misc.PlayerSettings.GetGumpHue( from ));
			AddButton(897, 10, 4017, 4017, 0, GumpButtonType.Reply, 0);
			AddHtml( 52, 14, 400, 20, @"<BODY><BASEFONT Color=" + color + ">ABILITY BAR - MONKS - II</BASEFONT></BODY>", (bool)false, (bool)false);
