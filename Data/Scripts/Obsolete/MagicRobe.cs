...
namespace Server.Items
{
	public class MagicRobe : GoldRing
	{
		...
		public MagicRobe()
		{
			...
			switch( Utility.RandomMinMax( 1, 31 ) )
			{
				...
				case 5: ItemID = 0x302;	Name = "sage robe"; break;
				...
				case 9: ItemID = Utility.RandomList( 0x2652 ); Name = "scholar robe"; break;
			...
			//Name = RandomThings.MagicItemAdj( "start", false, false, ItemID ) + " " + Name;
		}
	...
	public class MangarsNecroRobe : MagicRobe
	{
		...
		{
			Item oldItem = (Item)state;
			Item newItem = new MangarNecroRobe();
			Server.Misc.Cleanup.DoCleanup( oldItem, newItem );
		}
	}
	...
	public class MangarsElementalistRobe : MagicRobe
	{
		...
		public MangarsElementalistRobe( Serial serial ) : base( serial )
		{
		}
		...
		{
			Item oldItem = (Item)state;
			Item newItem = new MangarElementalistRobe();
			Server.Misc.Cleanup.DoCleanup( oldItem, newItem );
		}
	}
}