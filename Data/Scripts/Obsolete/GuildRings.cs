...
namespace Server.Items
{
	public class GuildRings : GoldRing
	{
		...
		private void Cleanup( object state )
		{
			...
			if ( RingGuild == "MagesGuild" ){ guild = 1; }
			else if ( RingGuild == "WarriorsGuild" ){ guild = 1; }
			else if ( RingGuild == "ThievesGuild" ){ guild = 1; }
			else if ( RingGuild == "RangersGuild" ){ guild = 1; }
			else if ( RingGuild == "HealersGuild" ){ guild = 1; }
			else if ( RingGuild == "MinersGuild" ){ guild = 1; }
			else if ( RingGuild == "MerchantsGuild" ){ guild = 1; }
			else if ( RingGuild == "TinkersGuild" ){ guild = 1; }
			else if ( RingGuild == "TailorsGuild" ){ guild = 1; }
			else if ( RingGuild == "FishermensGuild" ){ guild = 1; }
			else if ( RingGuild == "BardsGuild" ){ guild = 1; }
			else if ( RingGuild == "BlacksmithsGuild" ){ guild = 1; }
			else if ( RingGuild == "NecromancersGuild" ){ guild = 1; }
			else if ( RingGuild == "AlchemistsGuild" ){ guild = 1; }
			else if ( RingGuild == "DruidsGuild" ){ guild = 1; }
			else if ( RingGuild == "ArchersGuild" ){ guild = 1; }
			else if ( RingGuild == "CarpentersGuild" ){ guild = 1; }
			else if ( RingGuild == "CartographersGuild" ){ guild = 1; }
			else if ( RingGuild == "LibrariansGuild" ){ guild = 1; }
			else if ( RingGuild == "CulinariansGuild" ){ guild = 1; }
			else if ( RingGuild == "AssassinsGuild" ){ guild = 1; }
			else if ( RingGuild == "ElementalGuild" ){ guild = 1; }

			Item item = new GuildRing( RingOwner, guild );
