		...
		private class WearTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				if ( targeted is Item )
				{
					...
					{
						from.SendMessage( "You can only use this hammer on items in your possession." );
					}
					...
					else if ( iWear is WizardStick || iWear is GiftSceptre || iWear is LevelSceptre )
					{
						...
						else if ( iWear.ItemID == 0x0DF5 ){ iWear.ItemID = 0x639D; }
						else if ( iWear.ItemID == 0x639D ){ iWear.ItemID = 0x639E; }
						else if ( iWear.ItemID == 0x639E ){ iWear.ItemID = 0x639F; }
						else if ( iWear.ItemID == 0x639F ){ iWear.ItemID = 0x63A0; }
						else if ( iWear.ItemID == 0x63A0 ){ iWear.ItemID = 0x269D; }
					...
					else if ( iWear is BaseWeapon )
					{
						...
						if ( weapon.Name != null && weapon.Name != "" ){ NewName = weapon.Name; } else { NewName = iWear.Name; }

						if ( iWear.ItemID == weapon.ItemID ){ from.PlaySound( 0x233 ); from.SendMessage( "The hammer's magic did not affect the weapon." ); }
						else { from.PlaySound( 0x541 ); from.SendMessage( "The hammer magical transforms the weapon." ); }
					...
					else if ( iWear is BaseArmor )
					{
						...
						else if ( iWear.ItemID == 0x2FBB ){ DoEffects = true; iWear.ItemID = 0x267F; NewName = "dread helm"; }
						else if ( iWear.ItemID == 0x267F ){ DoEffects = true; iWear.ItemID = 0x2B10; NewName = "royal helm"; }
						...
						else if ( iWear.ItemID == 0x140C || iWear.ItemID == 0x140D ){ DoEffects = true; iWear.ItemID = 0x2653; NewName = "chainmail coif"; }
						else if ( iWear.ItemID == 0x2653 ){ DoEffects = true; iWear.ItemID = 0x2649; NewName = "platemail helm"; }
						else if ( iWear.ItemID == 0x2649 ){ DoEffects = true; iWear.ItemID = 0x2774; NewName = "chainmail hatsuburi"; }
						...
						else if ( iWear.ItemID == 0x2FCB || iWear.ItemID == 0x3181 ){ DoEffects = true; iWear.ItemID = 0x1B72; NewName = "large shield"; }
						...
						else if ( iWear.ItemID == 0x264A ){ DoEffects = true; iWear.ItemID = 0x13C4; NewName = "chainmail tunic"; }
						else if ( iWear.ItemID == 0x13C4 ){ DoEffects = true; iWear.ItemID = 0x13BF; NewName = "chainmail tunic"; }
						else if ( iWear.ItemID == 0x13BF ){ DoEffects = true; iWear.ItemID = 0x13EC; NewName = "ringmail tunic"; }
						else if ( iWear.ItemID == 0x13EC || iWear.ItemID == 0x13ED ){ DoEffects = true; iWear.ItemID = 0x6399; NewName = "platemail tunic"; }
						else if ( iWear.ItemID == 0x6399 ){ DoEffects = true; iWear.ItemID = 0x639A; NewName = "platemail tunic"; }
						else if ( iWear.ItemID == 0x639A ){ DoEffects = true; iWear.ItemID = 0x639B; NewName = "platemail tunic"; }
						else if ( iWear.ItemID == 0x639B ){ DoEffects = true; iWear.ItemID = 0x639C; NewName = "platemail tunic"; }
						else if ( iWear.ItemID == 0x639C ){ DoEffects = true; iWear.ItemID = 0x1415; NewName = "platemail tunic"; }
						...
						else if ( iWear.ItemID == 0x277D || iWear.ItemID == 0x27C8 ){ DoEffects = true; iWear.ItemID = 0x2654; NewName = "chainmail tunic"; }
						else if ( iWear.ItemID == 0x2654 ){ DoEffects = true; iWear.ItemID = 0x2641; NewName = "scalemail tunic"; }
						else if ( iWear.ItemID == 0x2641 || iWear.ItemID == 0x2642 ){ DoEffects = true; iWear.ItemID = 0x2655; NewName = "chainmail tunic"; }
						else if ( iWear.ItemID == 0x2655 ){ DoEffects = true; iWear.ItemID = 0x264A; NewName = "platemail tunic"; }

						else if ( iWear.ItemID == 0x63B4 ){ DoEffects = true; iWear.ItemID = 0x2647; NewName = "scalemail leggings"; }
						...
						else if ( iWear.ItemID == 0x13F0 || iWear.ItemID == 0x13F1 ){ DoEffects = true; iWear.ItemID = 0x6396; NewName = "platemail leggings"; }
						else if ( iWear.ItemID == 0x6396 ){ DoEffects = true; iWear.ItemID = 0x6397; NewName = "platemail leggings"; }
						else if ( iWear.ItemID == 0x6397 ){ DoEffects = true; iWear.ItemID = 0x6398; NewName = "platemail leggings"; }
						else if ( iWear.ItemID == 0x6398 ){ DoEffects = true; iWear.ItemID = 0x46AA; NewName = "platemail leggings"; }
						else if ( iWear.ItemID == 0x46AA || iWear.ItemID == 0x141B ){ DoEffects = true; iWear.ItemID = 0x13be; NewName = "chainmail leggings"; }
						else if ( iWear.ItemID == 0x13be ){ DoEffects = true; iWear.ItemID = 0x13c3; NewName = "chainmail leggings"; }
						else if ( iWear.ItemID == 0x13c3 ){ DoEffects = true; iWear.ItemID = 0x2B06; NewName = "royal leggings"; }
						else if ( iWear.ItemID == 0x2B06 || iWear.ItemID == 0x2B07 ){ DoEffects = true; iWear.ItemID = 0x2656; NewName = "chainmail leggings"; }
						else if ( iWear.ItemID == 0x2656 ){ DoEffects = true; iWear.ItemID = 0x264D; NewName = "platemail leggings"; }
						else if ( iWear.ItemID == 0x264D ){ DoEffects = true; iWear.ItemID = 0x2659; NewName = "chainmail leggings"; }
						else if ( iWear.ItemID == 0x2659 ){ DoEffects = true; iWear.ItemID = 0x63B4; NewName = "chainmail skirt"; }
						...
						else if ( iWear.ItemID == 0x305 ){ DoEffects = true; iWear.ItemID = 0x2D01; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x2D01 ){ DoEffects = true; iWear.ItemID = 0x2D02; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x2D02 ){ DoEffects = true; iWear.ItemID = 0x2D03; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x2D03 ){ DoEffects = true; iWear.ItemID = 0x2D04; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x2D04 ){ DoEffects = true; iWear.ItemID = 0x306; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x306 ){ DoEffects = true; iWear.ItemID = 0x264E; NewName = "platemail arms"; }
						else if ( iWear.ItemID == 0x264E ){ DoEffects = true; iWear.ItemID = 0x2B0A; NewName = "royal arms"; }
