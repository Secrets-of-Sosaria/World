			...
			if ( MCparent.AmountTamed >= MCparent.AmountToTame)
				{
									...
									else if (MCparent.Reward < 249999)
									...
									if (reward >= 1000)  // top top top tier
									{
											switch ( Utility.Random( 33 ) ) // 10%
											{
												...
												case 1: shelf = new PowerScroll( SkillName.Druidism, 25); break;
												case 2: shelf = new PowerScroll( SkillName.Taming, 25); break;
									...
									if (reward >= 600)  // top top top tier
									{
											...
											{
												case 0: shelf = new ParagonPetDeed(); break;
												case 1: shelf = new PowerScroll( SkillName.Druidism, 20); break;
												case 2: shelf = new PowerScroll( SkillName.Taming, 20); break;
												case 3: shelf = Construct( m_MegaRareMorph ) as Item; break;
											}
									}									
									...
									if (reward >= 470 && shelf == null)  // impossible finds
									{
											switch ( Utility.Random( 87 ) ) // 8%
											{
												...
												case 2: shelf = new PowerScroll( SkillName.Druidism, 15); break;
									...
									if (reward >= 375 && shelf == null) // rare finds
									{
											...
											{						
												...
												case 11: shelf = Construct( m_RareMorph ) as Item; break;
									...
									if (reward >=250 && shelf == null) // medium finds
									{
											switch ( Utility.Random( 56 ) ) // 25%
											{
												...
												case 8: shelf = new PowerScroll( SkillName.Druidism, 5); break;
												case 9: shelf = new PowerScroll( SkillName.Taming, 5); break;
												case 10: shelf = new PetGrowthDeedWeak( ); break;
												case 11: shelf = Construct( m_LowMorph ) as Item; break;
												case 12: shelf = Construct( m_MidMorph ) as Item; break;
