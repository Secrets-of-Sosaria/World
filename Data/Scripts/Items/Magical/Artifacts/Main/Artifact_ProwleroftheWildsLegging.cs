...
{
	public class Artifact_ProwleroftheWildsLegging : GiftOniwabanLeggings
	{
		...
		[Constructable]
		public Artifact_ProwleroftheWildsLegging()
		{
			Name = "Leggings of the Prowler";
			Hue = 0x30A;
			ArtifactLevel = 2;
			SkillBonuses.SetValues( 0, SkillName.Marksmanship, 5 + (Utility.RandomMinMax(0,2)*5) );
			SkillBonuses.SetValues( 1, SkillName.Stealth, 5 + (Utility.RandomMinMax(0,2)*5) );
		...
		public Artifact_ProwleroftheWildsLegging( Serial serial ) : base( serial )
		{
		}
