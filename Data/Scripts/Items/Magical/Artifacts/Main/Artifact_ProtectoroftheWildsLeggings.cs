...
{
	public class Artifact_ProtectoroftheWildsLeggings : GiftWoodenPlateLegs
	{
		...
		[Constructable]
		public Artifact_ProtectoroftheWildsLeggings()
		{
			Name = "Leggings of the Wilds";
			Hue = 0x21F;
			ArtifactLevel = 2;
		...
		public Artifact_ProtectoroftheWildsLeggings( Serial serial ) : base( serial )
		{
		}
