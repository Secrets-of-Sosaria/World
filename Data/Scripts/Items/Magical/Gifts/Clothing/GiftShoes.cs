...
namespace Server.Items
{
	...
	[FlipableAttribute( 0x2FC4, 0x317A )]
	public class GiftHikingBoots : BaseGiftShoes
	{
		public override CraftResource DefaultResource{ get{ return CraftResource.RegularLeather; } }

		[Constructable]
		public GiftHikingBoots() : this( 0 )
		{
		}

		[Constructable]
		public GiftHikingBoots( int hue ) : base( 0x2FC4, hue )
		{
			Name = "Hiking boots";
			Weight = 2.0;
		}

        public GiftHikingBoots(Serial serial)
            : base(serial)
		{
		}
