			...
			if ( o is Item )
			{
				...
				else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
				{
					...
					if (i_DI >= 70)
					{
						...
						from.SendMessage(32, "You need at least 100.0 blacksmith and 80.0 knightship to sharpen weapons with this stone");
					else if (from.Skills[SkillName.Knightship].Value < 80.0)
						from.SendMessage(32, "You need at least 100.0 blacksmith and 80 knightship to sharpen weapons with this stone");
					else if ( !Deleted )
					{
